...
| ------------- | ----- | ------------------------------------- |
| OSX/Linux: <br>[Ruby](https://www.ruby-lang.org/en/)<br><br>Windows: <br>[Ruby](http://rubyinstaller.org/) | version 2.1.2 preferred, but anything 1.9.3 and up should work fine | Run `ruby --version` at Command Prompt/Terminal. <br><br>Expected outcome: Should report a version `1.9.3` or greater. |
