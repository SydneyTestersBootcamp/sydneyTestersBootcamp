...
| ------------- | ----- | ------------------------------------- |
| OSX/Linux: <br>[Ruby](https://www.ruby-lang.org/en/)<br><br>Windows: <br>[Ruby](http://rubyinstaller.org/downloads/) | Version 2.1.2 or 2.1.3 preferred | Run `ruby --version` at Command Prompt/Terminal. <br><br>Expected outcome: Should report a version `2.1.2` or greater. |
